...
class EditarUsuarioForm extends Form implements InputFilterProviderInterface
{
                ...
                'validators' => [
                    [
                        ...
                        'options' => [
                            'messages' => [
                                // Substitui a mensagem padrão para campo vazio
                                Validator\NotEmpty::IS_EMPTY => 'Informe o nível do usuário',
                            ],
                        ],
                    ],
                    [
                        ...
                        'options' => [
                            ...
                            'max' => 8,
                            'messages' => [
                                StringLength::TOO_SHORT => 'somente "titular" , "monitor" ou "admin"',
                                StringLength::TOO_LONG  => 'somente: "titular" , "monitor" ou "admin"',
                            ],
                        ],
                    ],
                ],
